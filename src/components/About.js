      ...
      <section className='about' id='about'>
        <div className='about-text'>
          ...
          <p>
            ...
            part in nurturing it within any organization. I'm super excited
            about the idea of bringing my skills and limitless potential for
            growth to your awesome company.
            <br />
            <br />
            ...
            some post-graduation travel adventures. In my downtime, you'll find
            me out in nature, hiking and soaking up the great outdoors. I'm also
            a bit of a culture enthusiast, always eager to dive into new
            experiences and learn from different walks of life. Oh, and let's
            not forget my love for the open road – nothing beats the thrill of a
            good motorcycle ride!
            <br />
            <br />
